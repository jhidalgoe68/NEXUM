...
export default function Advisory() {
  return (
    <section className="section" id="advisory">
      <div className="wrap">
        <div className="marker reveal">06 / Advisory</div>

        <div className="advisory-grid">
          <div className="advisory-portrait reveal">
            <div className="portrait-frame">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                src="/images/javier-hidalgo.jpg"
                alt="Javier Hidalgo Estevez — Fundador NEXUM"
                loading="lazy"
                width="800"
                height="800"
              />
          ...
          <div className="advisory-content">
            ...
            <div className="advisory-ctas reveal d4">
              <Link href="#contacto" className="btn btn-primary">Conversar con nosotros</Link>
              <a 
                href="https://wa.me/50670104381?text=Hola%2C%20me%20gustar%C3%ADa%20conversar%20con%20NEXUM"
                target="_blank" 
